...
import ImportSkill from "../data/import.skill";
...
const SkillPage = () => {
  ...
  const [openModalImportSkill, setOpenModalImportSkill] =
  ...
  return (
    <div>
          ...
          return (
            <>
              ...
              <Button
                ...
                type="primary"
                onClick={() => setOpenModalImportSkill(true)}
              >
                Import
              </Button>
      ...
      />
      <ImportSkill
        openModalImportSkill={openModalImportSkill}
        setOpenModalImportSkill={setOpenModalImportSkill}
        reloadTable={reloadTable}
      />
    </div>
  );
